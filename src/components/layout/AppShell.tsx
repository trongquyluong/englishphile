...
export function AppShell({ children, user }: AppShellProps) {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <footer className="mx-auto mt-8 flex w-full max-w-7xl flex-col gap-2 border-t border-line px-4 py-5 text-sm text-ink-soft sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
        <p className="font-medium">Englishphile - Engcrease your English</p>
        <nav className="flex flex-wrap gap-x-5" aria-label="Liên kết chân trang">
